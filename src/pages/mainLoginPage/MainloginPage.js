...
const clickHandler=()=> {
  ...
  return (
    ...
    <div className='row justify-content-between align-items-center'>
      ...
      {login ? (
    <img src={loginpageImg} className='img-fluid' alt='loginpageImg' />
  ) : (
    <img src={loginImage} className='img-fluid' alt='loginpageImg' />
      ...
      <Row className=' justify-content-center '>
        <Col className='col-12  col-md-9 mt-5' >
          <Nav variant="pills" className="flex-row  Toggler justify-content-center border">
            <Nav.Item  >
              <Nav.Link eventKey="first" onClick={clickHandler}>Sign in</Nav.Link>
            </Nav.Item>
            <Nav.Item>
              <Nav.Link eventKey="second"  onClick={clickHandler}>Sign Up</Nav.Link>
            </Nav.Item>
          </Nav>
        </Col>
